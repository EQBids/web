<div class="row">
    <div class="col-md-12">
        @include('web.admin.equipments.category.breadcrum',['current_category'])
    </div>
</div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="product mb-40">
                    <div class="product-image">
                        <a href="{{ route('admin.equipment.listing.category',[$category['slug']]) }}">
                            <img class="img-fluid mx-auto" src="{{ $category['thumbnail']?asset($category['thumbnail']):'http://via.placeholder.com/350x150' }}" alt="">
                        </a>
                    </div>
                    <div class="product-des">
                        <div class="product-title">
                            <a href="{{ route('admin.equipment.listing.category',[$category['slug']]) }}">{{ $category['name'] }} ({{ isset($category['subcategories_items'])?$category['subcategories_items']:$category['equipments_count']}})</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="product listing">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="product-image">
                                    <a href="{{ route('admin.equipment.listing.show',[$equipment->id]) }}">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="product-des text-left">
                                    <div class="product-title">
                                        <a href="{{ route('admin.equipment.listing.show',[$equipment->id]) }}">{{ $equipment->name }}</a>
                                    </div>
