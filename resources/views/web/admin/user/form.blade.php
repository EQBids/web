...
{{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <input name="company_name" class="form-control"
                data-parsley-maxlength="150"
                   value="{{ old('company_name',((isset($user) && count($user->contractors) > 0)?
                    $user->contractors->first()->company_name: (( isset($user) && count($user->suppliers) > 0 ) ?
                     $user->suppliers->first()->name : '' ))) }}"
            />
        </div>
        ...
        <div class="form-group">
            ...
            >{{ old('address',( (isset($user) && count($user->contractors) > 0 ) ? $user->contractors->first()->address:
                 (( isset($user) && count($user->suppliers) > 0 ) ? $user->suppliers->first()->name : '' ) ) ) }}</textarea>
        </div>
