...
use App\Repositories\Eloquent\Product\OfficeRepository;
...
class UsersController extends Controller
{
    ...
    public function index()
    {
	    ...
	    return view('web.supplier.user.index')->with(compact('data'));
    }
    ...
    public function store(createSubUserRequest $request)
    {
    	try {
		    ...
		    $supplier = $this->office_repository->findOneBy($request->get('office_id'));
		    $userData['country_id']=$supplier->country_id;
		    $userData['state_id']=$supplier->state_id;
		    $userData['city_id']=$supplier->city_id;
			...
			$userData['supplier_id']=$request->get('office_id');
		    $this->users_repository->createWithRole( $userData, $role );

		    return redirect( route( 'supplier.users.index' ) )->with( 'notifications', collect( [
			    [
    ...
    public function edit(User $user)
    {
	    ...
	    return view('web.supplier.user.edit')->with($viewData);
    }
	...
	public function delete(User $user){
		return view('web.supplier.user.delete')->with(compact('user'));
	}
}
